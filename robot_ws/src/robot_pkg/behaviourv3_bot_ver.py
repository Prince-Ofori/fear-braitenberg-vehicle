# -*- coding: utf-8 -*-
""" Defines the behaviour of a wandering, fearful robot avoiding the green sliced object """
import cv2
import numpy as np 
import rospy
...
class behaviour:
    ...
    def __init__(self):
        ...
        self.imsub = rospy.Subscriber("/camera/rgb/image_raw",
                                          Image, self.callback)
    ...
    def callback(self, data):
        ...
        bgr_thresh = cv2.inRange(self.cv_image,
                                 np.array((0, 0, 0)),
                                 np.array((0, 255, 0)))
